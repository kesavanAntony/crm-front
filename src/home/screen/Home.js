        ...
        <div className="container">
          <div className="row ">
            <div className="jumbotron my-5 shadow p-3 mb-5 bg-secondary text-light rounded">
              ...
              <p className="lead">
                <strong>OPTIMISTA</strong> was founded in the Year 2023.
              </p>
              <hr className="my-4" />
              <p>
                Our Aim and Goal is to make digital payments Easy &amp;Safe also ensure that people
                never felt the need to carry cash again.OPTIMISTA was started with an idea to
                ...
                the service providers using OPTIMISTA electronic transaction processing platform,
                the consumer can do transaction by visiting retail touch points either they can pay
                digitally or by way of cash. We at OPTIMISTA believe in the business philosophy of
                ...
                towns in South India.OPTIMISTA envisions becoming a one-step shop for retails in
                their quest of serving the end customer.
              </p>
              <p>
                <strong>OPTIMISTA</strong> also works with banks to empower these unbanked people
                to access digital financial services for the very first time. Thus, the OPTIMISTA
